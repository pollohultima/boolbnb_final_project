...
<div class="edit_sec">
    ...
    <form action="{{ route('host.apartments.update', $apartment->slug) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" id="title" class="form-control @error('title') is_invalid @enderror" placeholder="inserisci titolo" aria-describedby="helpId" value="{{ old('title') ? old('title') : $apartment->title  }}">
        </div>

        <div class="mb-3">
            <label for="rooms" class="form-label">Stanze</label>
            <input type="text" name="rooms" id="rooms" class="form-control  @error('rooms') is_invalid @enderror" placeholder="inserisci camere" aria-describedby="helpId" value="{{ old('rooms') ? old('rooms') : $apartment->rooms  }}">
        </div>

        <div class="mb-3">
            <label for="bathrooms" class="form-label">Bagni</label>
            <input type="text" name="bathrooms" id="bathrooms" class="form-control  @error('bathrooms') is_invalid @enderror" placeholder="inserisci il numero di bagni" aria-describedby="helpId" value="{{ old('bathrooms') ? old('bathrooms') : $apartment->bathrooms  }}">
        </div>

        <div class="mb-3">
            <label for="beds" class="form-label">Posti letto</label>
            <input type="text" name="beds" id="beds" class="form-control  @error('beds') is_invalid @enderror" placeholder="inserisci il numero di posti letto" aria-describedby="helpId" value="{{ old('beds') ? old('beds') : $apartment->beds  }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="floor" id="floor" class="form-control  @error('floor') is_invalid @enderror" placeholder="inserisci piano" aria-describedby="helpId" value="{{ old('floor') ? old('floor') : $apartment->floor  }}">
        </div>

        <div class="mb-3">
            <label for="price" class="form-label">Prezzo</label>
            <input type="text" name="price" id="price" class="form-control  @error('price') is_invalid @enderror" placeholder="inserisci prezzo" aria-describedby="helpId" value="{{ old('price') ? old('price') : $apartment->price  }}">
        </div>
